	...
	<div class="container-fluid">
		...
		<div class="container">
		   <ol class="breadcrumb" style="background:white">
			...
			<form onsubmit="return mycheck()" action="${pageContext.request.contextPath }/item/add.action" enctype="multipart/form-data" method="post">
				<div class="table-responsive">
				    <table border="0px" cellspacing="10" id="formTable">
					 <caption style="text-align:center">添加商品</caption>
					<tr>
						<td>
							 <div class="form-group">
							    <label for="itemName"><font color="red">*</font>商品名称：</label><span class=" pull-right warn" id="itemNameWarn" ></span>
							    <input type="text" class="form-control" id="itemName" name="itemName" placeholder="商品名称">
							 </div>
					    </td>
					    <td>
					    	<div class="form-group">
							    <label for="itemClass"><font color="red">*</font>商品类型：</label><span class=" pull-right warn" id="itemClassWarn" ></span>
							    <select name="itemClass" class="form-control" id="itemClass">
					    ...
					    <td>
					    	<div class="form-group">
							    ...
							    <div class="input-group">
							      ...
							      <input type="text" class="form-control" id="itemPrice" name="itemPrice" placeholder="价格">
							      <div class="input-group-addon addon">元</div>
							    </div>
							 </div>
					    </td>
					    <td>
					    	<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="itemDisCount" name="itemDisCount" placeholder="0~1之间的小数,默认为1">
							 </div>
					    </td>
					</tr>
					...
					<tr>
						<td>
					    	<div class="form-group">
							    ...
							    <textarea  class="form-control" id="itemDesc" name="itemDesc" rows="10" placeholder="400个字符以内"></textarea>
							 </div>
					    </td>
					    <td>
					    	<div class="form-group">
							    <label for="items_pic1">商品图片</label>
							    ...
							    <p class="help-block">请上传三张商品图片.格式jpg 、jpeg、png <br/>每张图片的最大尺寸为5MB,宽高比为1:1</p>
						    </div>
					    </td>
					</tr>
					<tr>
					   <td>
					    	<div class="form-group">
							    ...
							    <input  class="form-control" id="itemAddress" name="itemAddress"></input>
							 </div>
							 <div class="form-group">
							    <label for="itemCreatetime">生产日期：</label>
							    <input  class="form-control" id="iitemCreatetime" name="itemCreatetime"></input>
							 </div>
							  <div class="form-group">
							    <label for="itemExpirtime">商品有效期：</label>
							    <input  class="form-control" id="itemExpirtime" name="itemExpirtime"></input>
							 </div>
							 <div class="form-group">
							    <label for="itemNorm">商品规格：</label>
							    <input type="text" class="form-control" id="itemNorm" name="itemNorm" placeholder="商品规格">
							 </div>
					    </td>
					    <td>
					    	<div class="form-group">
					...
					<tr>
				    	<td>
							<div class="form-group">
							    ...
							    <input type="text" class="form-control" id="itemCount" name="itemCount" placeholder="库存数量，默认为充足">
							 </div>
						</td>
						<td>
						  <div class="form-group">
							    <label for="itemStatus">商品状态：</label><span class=" pull-right warn" id="itemClassWarn" ></span>
							    <select name="itemStatus" class="form-control" id="itemStatus">
					...
					<tr>
						<td colspan="2" >
							<input type="submit"  class="btn btn-info pull-right" style="width: 90px;" value="添加">
						</td>
					</tr>
				  </table>
			</div>
